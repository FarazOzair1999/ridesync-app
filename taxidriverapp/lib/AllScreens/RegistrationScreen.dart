...
import 'package:taxidriverapp/AllScreens/LoginScreen.dart';
import 'package:taxidriverapp/AllScreens/carInfoScreen.dart';
  ...
  void registerNewUser(BuildContext context) async
  {
    ...
    try {
      ...
      if (userCredential != null){
        ...
        driverRef.child(userCredential.uid).set(userDataMap);
