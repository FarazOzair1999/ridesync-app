...
import 'package:taxidriverapp/AllScreens/AllWidgets/collectFareDialog.dart';
...
import 'package:taxidriverapp/Assistants/mapKitAssistant.dart';
...
class _NewRideScreenState extends State<NewRideScreen> {
        ...
        children: [
          GoogleMap(
            ...
            onMapCreated: (GoogleMapController controller) async
            {
              ...
              var dropOffLatLng=widget.rideDetails.dropoff;
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Image.asset("images/location-icon-png-4243.png",height: 16.0, width: 16.0, color: Colors.blue,),
                        SizedBox(
                          width: 18.0,
                        ),
                        Expanded(
                    ...
                    Row(
                      children: [
                        Image.asset("images/location-icon-png-4243.png",height: 16.0, width: 16.0, color: Colors.green,),
                        SizedBox(
                          width: 18.0,
                        ),
                        Expanded(
                        ...
                        if(status=="accepted")
                          {
                            ...
                            showDialog(context: context,
                                ...
                                builder: (BuildContext context) => ProgressDialoq(message: "Please Wait...",),
                            );
  ...
  void initTimer()
  {
    ...
    timer=Timer.periodic(interval, (timer) {
      rideDurationCounter=rideDurationCounter+1;
    });
  }
  endTheTrip() async {
    timer.cancel();
    showDialog(context: context,
        barrierDismissible: false,
        builder: (BuildContext context)=> ProgressDialoq(message:"Please Wait Ending ride..."),
    );
    ...
    double fareAmount = AssistantMethods.calculateFares(directionDetails);
    String rideRequestId=widget.rideDetails.ride_request_id;
